...
if(d){try{var e=JSON.parse(d);b.log("_History.onPopState: state anchor",d,e);b.replaceState(e.data,e.tite,e.url)}catch(g){b.log("_History.onPopState: traditional anchor",d);b.Adapter.trigger(i,"anchorchange")}return false}d={};var h=e=null;d=null;a=a||{};if(typeof a.state==="undefined")if(typeof a.originalEvent!=="undefined"&&typeof a.originalEvent.state!=="undefined")a.state=a.originalEvent.state;if(a.state===null)d=a.originalEvent.state;else if(typeof a.state!=="undefined"){e=b.expandUrl(f.location.href);
d=c.getStateByUrl(e);e=c.urlDuplicateExists(e);d=typeof d!=="undefined"&&!e?d.data:a.originalEvent.state}else{e=b.expandUrl(f.location.href);d=c.getStateByUrl(e);if(e==d.url)d=d.data;else throw Error("Unknown state");}d=typeof d!=="object"||d===null?{}:d;e=d.title||"";h=d.url||f.location.href;d=b.createStateObject(d,e,h);if(c.isLastState(d)){b.log("_History.onPopState: no change");return false}c.storeState(d);c.saveState(d);if(d.title)f.title=d.title;b.Adapter.trigger(i,"statechange");return true};
b.Adapter.bind(i,"popstate",c.onPopState);b.pushState=function(a,d,e){if(b.extractHashFromUrl(e))throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");a=b.createStateObject(a,d,e);c.storeState(a);k.pushState(a.data,a.title,a.url);b.Adapter.trigger(i,"popstate");return true};b.replaceState=function(a,d,e){if(b.extractHashFromUrl(e))throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");a=b.createStateObject(a,d,e);c.storeState(a);
k.replaceState(a.data,a.title,a.url);b.Adapter.trigger(i,"popstate");return true}}b.back=function(){b.debug("History.back: called");if(b.emulated.hashChange&&c.isInternetExplorer()){var a=b.getHash();setTimeout(function(){if(b.getHash()===a){b.debug("History.back: trying again");return b.back()}return true},b.options.hashChangeCheckerDelay*2)}return k.go(-1)};b.forward=function(){b.debug("History.forward: called");if(b.emulated.hashChange&&c.isInternetExplorer()){var a=b.getHash();setTimeout(function(){if(b.getHash()===
a){b.debug("History.forward: trying again");return b.forward()}return true},b.options.hashChangeCheckerDelay*2)}return k.go(1)}};typeof b.Adapter!=="undefined"&&b.init()})(window);
