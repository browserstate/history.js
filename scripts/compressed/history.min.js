(function(g){g.History=g.History||{};var a=g.History,h=g.history;if(typeof a.emulated!=="undefined")throw Error("History.js has already been emulated...");a.init=function(){a.emulated={pushState:!Boolean(g.history&&g.history.pushState&&g.history.replaceState),hashChange:Boolean(!("onhashchange"in g||"onhashchange"in document)||a.Adapter.getBrowserFlag()==="msie"&&a.Adapter.getBrowserMajorVersion()<8)};a.debug=function(){a.debug.enable&&a.log.apply(a,arguments)};a.log=function(){if(typeof console===
...
function(){h.back.apply(h,arguments)};a.forward=function(){h.forward.apply(h,arguments)}}};typeof a.Adapter!=="undefined"&&a.init()})(window);
